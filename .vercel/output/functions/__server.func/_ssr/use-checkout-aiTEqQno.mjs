...
//#region node_modules/.nitro/vite/services/ssr/assets/use-checkout-aiTEqQno.js
...
createServerFn({ method: "GET" }).middleware([authMiddleware]).inputValidator(getOrdersSchema).handler(createSsrRpc("b38001c73eb49fc64730eb3ec7d9a82d0997941cb00a1a0e8ace384a7c5ffdb3"));
