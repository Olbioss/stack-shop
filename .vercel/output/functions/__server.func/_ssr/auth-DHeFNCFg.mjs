...
import { $t as BetterAuthError, Bt as looseObject, C as getBetterAuthVersion, Ct as initGetModelName, E as base64Url, Et as createRandomStringGenerator, Ft as boolean$1, Gt as string, Ht as object, Jt as xor, Kt as union, Mt as _enum, Nt as any, O as decodeProtectedHeader, Ot as boolean, Pt as array, Qt as APIError, Rt as email, S as runWithEndpointContext, St as getAuthTables, Tt as generateId, Ut as optional, Vt as number, Wt as record, _ as runWithTransaction, _t as ATTR_CONTEXT, a as isValidIP, an as shouldPublishLog, b as runWithRequestState, bt as import_src, c as normalizePathname, ct as encode, d as isAPIError, dn as isProduction, en as kAPIErrorHeaderSymbol, f as createRouter$1, fn as isTest, g as runWithAdapter, gt as withSpan, h as queueAfterTransactionHook, i as createRateLimitKey, in as logger, jt as string$1, k as jwtVerify, l as createAuthEndpoint, m as getCurrentAdapter, mt as whereOperators, n as socialProviders, o as normalizeIP, p as toResponse, r as isLoopbackHost, rn as createLogger, rt as JWTExpired, s as deprecate, sn as env, t as SocialProviderListEnum, tn as BASE_ERROR_CODES, u as createAuthMiddleware, un as isDevelopment, v as defineRequestState, vt as ATTR_HOOK_TYPE, w as filterOutputFields, wt as initGetFieldName, x as getCurrentAuthContext, xt as safeJSONParse, y as hasRequestState, yt as ATTR_OPERATION_ID } from "../_libs/@better-auth/core+[...].mjs";
import { a as defaultRoles, c as getOrigin, d as isDynamicBaseURLConfig, f as isRequestLike, g as wildcardMatch, l as getProtocol, n as PACKAGE_VERSION, o as getBaseURL, p as resolveBaseURL, r as TWO_FACTOR_ERROR_CODES, s as getHost, t as ADMIN_ERROR_CODES, u as hasPermission } from "./has-permission-ZBCGrJAj.mjs";
import { n as defu, t as createDefu } from "../_libs/defu.mjs";
import { w as require_jsx_runtime } from "../_libs/@radix-ui/react-accordion+[...].mjs";
import { n as __reExport, t as __exportAll } from "./rolldown-runtime-BYF0ZUUg.mjs";
import { t as dist_exports } from "../_libs/@better-auth/drizzle-adapter+[...].mjs";
import { a as twoFactor$1, l as verification, n as session, o as user, t as account } from "./shop-schema-C6uNILQs.mjs";
...
import { a as verifyPassword, i as hashPassword, n as createHMAC, r as binary, t as createOTP } from "../_libs/better-auth__utils.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/auth-DHeFNCFg.js
...
var createUser = (opts) => createAuthEndpoint("/admin/create-user", {
	...
	if (await ctx.context.internalAdapter.findUserByEmail(email$1)) throw APIError.from("BAD_REQUEST", ADMIN_ERROR_CODES.USER_ALREADY_EXISTS_USE_ANOTHER_EMAIL);
...
var admin = (options) => {
	...
	return {
		...
		schema: mergeSchema(schema$1, opts.schema),
		options
	};
};
...
var verifyBackupCodeBodySchema = object({
	...
	disableSession: boolean$1().meta({ description: "If true, the session cookie will not be set." }).optional(),
	trustDevice: boolean$1().meta({ description: "If true, the device will be trusted for 30 days. It'll be refreshed on every sign in request within this time. Eg: true" }).optional()
});
...
var backupCode2fa = (opts) => {
	...
	const passwordSchema = string().meta({ description: "The users password." });
	const generateBackupCodesBodySchema = opts.allowPasswordless ? object({ password: passwordSchema.optional() }) : object({ password: passwordSchema });
	return {
		id: "backup_code",
		version: PACKAGE_VERSION,
		endpoints: {
...
var verifyOTPBodySchema = object({
	...
	trustDevice: boolean$1().optional().meta({ description: "If true, the device will be trusted for 30 days. It'll be refreshed on every sign in request within this time. Eg: true" })
});
var send2FaOTPBodySchema = object({ trustDevice: boolean$1().optional().meta({ description: "If true, the device will be trusted for 30 days. It'll be refreshed on every sign in request within this time. Eg: true" }) }).optional();
/**
...
var totp2fa = (options) => {
	...
	const passwordSchema = string().meta({ description: "User password" });
	const getTOTPURIBodySchema = options?.allowPasswordless ? object({ password: passwordSchema.optional() }) : object({ password: passwordSchema });
	const twoFactorTable = "twoFactor";
	return {
		id: "totp",
		version: PACKAGE_VERSION,
...
var twoFactor = (options) => {
	...
	const passwordSchema = string().meta({ description: "User password" });
	const enableTwoFactorBodySchema = allowPasswordless ? object({
	...
	const disableTwoFactorBodySchema = allowPasswordless ? object({ password: passwordSchema.optional() }) : object({ password: passwordSchema });
	return {
		id: "two-factor",
		version: PACKAGE_VERSION,
		endpoints: {
		...
		hooks: { after: [{
			...
			handler: createAuthMiddleware(async (ctx) => {
				...
				if (returned instanceof Headers) {
					...
					const { setCookie } = await import("./server-sdejvwzy.mjs").then((n) => n.r).then((n) => n.t);
...
async function sendEmail({ to, subject, body, from }) {
	try {
		...
		return { messageId: (await transporter.sendMail({
...
function OtpEmail({ otp, userName = "there", expiresInMinutes = 5 }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Html, { children: [
		/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Head, {}),
		/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Preview, { children: ["Your verification code: ", otp] }),
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Section, {
						...
						children: [
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Text, {
								style: paragraph,
								children: [
									"Use the following code to verify your identity. This code will expire in ",
									expiresInMinutes,
									" minutes."
								]
							}),
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Text, {
								style: paragraph,
								children: "If you didn't request this code, you can safely ignore this email. Someone may have entered your email address by mistake."
							})
						]
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Section, {
...
var contentSection = { padding: "32px 40px" };
var heading = {
	color: "#18181b",
	fontSize: "22px",
	fontWeight: "600",
...
var auth = betterAuth({
	...
	trustedOrigins: [process.env.VITE_BETTER_AUTH_URL, ...process.env.BETTER_AUTH_URL ? [process.env.BETTER_AUTH_URL] : []],
	emailAndPassword: {
		enabled: true,
		disableSignUp: false,
	...
	plugins: [
		...
		twoFactor({
			...
			otpOptions: { async sendOTP({ user, otp }) {
...
//#endregion
export { sendEmail as n, auth as t };
