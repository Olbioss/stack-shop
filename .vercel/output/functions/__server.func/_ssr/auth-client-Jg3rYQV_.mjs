...
var { signIn, signOut, signUp, useSession, getSession, admin, twoFactor } = createAuthClient({
	baseURL: typeof import.meta !== "undefined" && "http://localhost:3000" || process.env.BETTER_AUTH_URL || "/api/auth",
	plugins: [adminClient(), twoFactorClient()]
});
//#endregion
export { twoFactor as a, signUp as i, signIn as n, useSession as o, signOut as r, admin as t };
