...
import { useCoupons } from "#/hooks/vendor/use-coupons";
import { shopBySlugQueryOptions } from "#/hooks/vendor/use-shops";
import { createVendorCouponsFetcher } from "#/hooks/vendor/use-vendor-entity-fetcher";
...
function RouteComponent() {
  ...
  const server = useMemo(() => createVendorCouponsFetcher(shopId), [shopId]);
