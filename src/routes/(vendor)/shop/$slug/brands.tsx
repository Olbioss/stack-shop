...
import { useBrands } from "#/hooks/vendor/use-brands";
import { shopBySlugQueryOptions } from "#/hooks/vendor/use-shops";
import { createVendorBrandsFetcher } from "#/hooks/vendor/use-vendor-entity-fetcher";
...
function RouteComponent() {
  ...
  const server = useMemo(() => createVendorBrandsFetcher(shopId), [shopId]);
