...
import { useTaxRates } from "#/hooks/vendor/use-tax-rates";
import { createVendorTaxRatesFetcher } from "#/hooks/vendor/use-vendor-entity-fetcher";
...
function RouteComponent() {
  ...
  const server = useMemo(() => createVendorTaxRatesFetcher(shopId), [shopId]);
