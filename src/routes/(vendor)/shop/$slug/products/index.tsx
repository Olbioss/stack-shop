...
import { attributesQueryOptions } from "#/hooks/vendor/use-attributes";
import { brandsQueryOptions } from "#/hooks/vendor/use-brands";
import { categoriesQueryOptions } from "#/hooks/vendor/use-category";
import { useProducts } from "#/hooks/vendor/use-products";
...
function RouteComponent() {
  ...
  const server = useMemo(() => createVendorProductsFetcher(shopId), [shopId]);
