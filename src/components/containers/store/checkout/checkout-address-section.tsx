...
export function CheckoutAddressSection({
  ...
  // Auto-select the default (or first) address once they load,
  // so checkout can proceed without requiring a manual click.
  useEffect(() => {
  ...
  }, [addresses, selectedAddress, handleAddressSelect]);
