...
export interface DataTableServer<TData> {
  ...
  // When set, becomes the prefix of the internal React Query cache key
  // ([...queryKey, params]) so callers can invalidate this table from outside.
  // Omit to fall back to ["datatable", context, params].
  queryKey?: QueryKey;
}
